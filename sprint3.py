    ...
    match opcaoInicial:
        ...
        case '1':
            ...
            while True:
                ...
                match opcaoLogado:
                    case '1':
                        extrato.mostra_extrato(reciclagens, trocasRecompenas, usuarioCorrente['id'], tiposDeLixo, recompensas, usuarios)
                    case '2':
                        reciclagem.fluxo_reciclagem(reciclagens, usuarios, tiposDeLixo, usuarioCorrente['id'], converte_data_em_string(datetime.now()))
                    case '3':
                        recompensa.fluxo_troca_recompensa(usuarioCorrente['id'], usuarios, trocasRecompenas, recompensas, converte_data_em_string(datetime.now()))
                    case '4':
